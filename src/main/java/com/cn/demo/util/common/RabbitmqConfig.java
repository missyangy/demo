...
public class RabbitmqConfig {
    ...
    public SimpleRabbitListenerContainerFactory multiListenerContainer() {
        ...
        factory.setConcurrentConsumers(environment.getProperty("spring.rabbitmq.listener.simpler.concurrency", int.class));
        factory.setMaxConcurrentConsumers(environment.getProperty("spring.rabbitmq.listener.simpler.max-concurrency", int.class));
        factory.setPrefetchCount(environment.getProperty("spring.rabbitmq.listener.simpler.prefetch", int.class));
        return factory;
    }
